...
HD_PWD='D:/proj/4.4CPU/mySCPU/mySCPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mySCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mySCPU.tcl
